...
<body onload="<?php if($this->session->flashdata('gl')=="true"){ echo "add_succ();"; }else{ } ?><?php if($this->session->flashdata('gl_error')=="true"){ echo "add_succ_error();"; }else{ } ?>">
  <div id="loader12"></div>
    <div id="wrapper">
      ...
      <?php include 'menu.php'; ?>
        ...
        <div id="page-wrapper">
          <div id="page-inner">
            <div class="row">
              <div class="col-md-12">
                <h1 class="page-head-line">Image Gallery</h1>
              </div>
            </div>
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#add_img" data-toggle="tab">Add Image</a>
                    </li>
                    <li class="">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade active in" id="add_img">
                      <hr>
                      <form role="form" method="post" action="<?php echo base_url(); ?>Main_con/add_gallery" enctype="multipart/form-data">
                       <div class="col-md-6" style="border:1px solid #ddd;">
                        <div class="form-group">
                         <label style="width:100%;margin-top: 15px;">Thumbnail Image</label>
                       ...
                       <div class="form-group">
                        <label style="width:100%;margin-top: 15px;">Original Image</label>
                        <div class="col-lg-4" style="padding-left:0px;">
                           <span class="btn btn-file btn-primary" style="width:100%;">
                             <span class="fileupload-new">Select File</span>
                        ...
                        <div class="form-group">
                         <label style="width:100%;margin-top: 15px;">Description</label>
                          <textarea class="form-control" name="description" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                          <button type="submit" class="btn btn-info" onclick="return subm();">Add To Gallery</button>
                        </div>
                      </div>
                     </form>
                    </div>
                    ...
                    <div class="tab-pane fade" id="gallery">
                      ...
                      <?php
      		            ...
      		            ?>
                      <div class="col-md-2 col-sm-3" id="<?php echo $gl->id; ?>">
                       <div class="portfolio-item awesome mix_all" data-cat="awesome" >
                        <img src="assets/images/gallery/thumb/<?php echo $gl->thumb_img; ?>" class="img-responsive " alt="" />
                        <div style="padding-bottom:3px;text-align:center;">
                          <a class="preview btn btn-success btn-xs" title="<?php echo $gl->description; ?>" href="assets/images/gallery/original/<?php echo $gl->original_img; ?>">
                            <i class="fa fa-eye"></i>
                          </a>
                          <a data-delete="<?php echo $gl->id; ?>" class="btn delete_gallery btn-danger btn-xs" href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                        </div>
                       </div>
                      </div>
                      <?php }} ?>
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function () {
            ...
            if (wid=='262') {
              ...
              $('#file1_name').val('');
              sweetAlert("Dimension Error...", "Image size must be Width : 262px !", "error");
              ...
              var x=$(this).data('delete');
                    ...
                    .then((willDelete) => {
                      if (willDelete) {
                        $.ajax({
                                type: 'POST',
                                 url:"<?php echo base_url();?>Main_con/delete_gallery",
